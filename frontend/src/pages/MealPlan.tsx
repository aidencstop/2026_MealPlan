...
import { getCurrentMealPlan, getLastWeekIntake, saveLastWeekIntake } from '../services/mealPlanService';
...
function MealPlan() {
  ...
  return (
    <div className="page-container">
      ...
      {/* 지난주 섭취 기록 섹션 */}
      <div className="card">
        <h2 className="card-title">지난주 섭취 기록</h2>
        {lastWeekRecord ? (
          <div>
      ...
      {mealPlan && (
        <>
          <div className="card">
            <h2 className="card-title">금주 추천 식단</h2>
            <p className="info-text">
          ...
          {/* 영양소 정보 */}
          <div className="card">
            <h2 className="card-title">주간 영양소</h2>
          ...
          {lastWeekRecord && (
            <div className="card">
              <h2 className="card-title">지난주 평가</h2>
